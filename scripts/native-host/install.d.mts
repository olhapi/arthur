...
export interface InstallPlan { targets: Record<string, string>; payloads: Array<{ source: string; destination: string; mode: number }>; manifests: NativeManifest[]; }
...
export function applyInstallPlan(plan: InstallPlan, dependencies?: { fs?: unknown }): Promise<void>;
