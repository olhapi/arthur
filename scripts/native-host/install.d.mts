...
export interface InstallPlan { home: string; platform: string; targets: Record<string, string>; payloads: Array<{ source: string; destination: string; mode: number }>; writerIdentity: { destination: string; value: string; mode: number }; manifests: NativeManifest[]; }
...
export function readWriterIdentity(fs: unknown, pathname: string): Promise<string>;
